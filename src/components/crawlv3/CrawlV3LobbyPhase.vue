  ...
  <div class="mx-auto max-w-[100rem] py-8">
    <div class="grid gap-6 xl:grid-cols-[minmax(0,26rem)_minmax(0,1fr)_minmax(16rem,19rem)]">
      ...
      >
        ...
        <div v-if="selectedCategoryRows.length" class="mt-4 rounded-2xl border border-white/10 bg-white/5 p-4 text-sm">
          <div class="flex items-center justify-between gap-3 text-white/75">
            <span class="font-semibold">Category Counts</span>
            <span>{{ localSelectionIds.length }} total</span>
          </div>
          <div class="mt-3 space-y-2">
            <div
              v-for="{ category, count } in selectedCategoryRows"
